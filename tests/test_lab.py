...
subcommands: list[Command] = [
    ...
    Command(("process", "list"), needs_config=False, should_fail=False),
    Command(("process", "clean"), ("-a",), needs_config=False, should_fail=False),
    Command(("process", "stop"), ("5678",), needs_config=False, should_fail=False),
    Command(("process", "attach"), ("5678",), needs_config=False, should_fail=False),
