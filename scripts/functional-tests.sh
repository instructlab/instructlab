...
test_oci_model_download_with_vllm_backend(){
   # Enable globstar for recursive globbing
    ...
    patterns=(
        "models/instructlab/granite-7b-lab-latest/config.json"
        "models/instructlab/granite-7b-lab-latest/tokenizer.json"
        "models/instructlab/granite-7b-lab-latest/tokenizer_config.json"
        "models/instructlab/granite-7b-lab-latest/*.safetensors"
    )
