...
test_init() {
    ...
    if [ "$SMALL" -eq 1 ]; then
        ...
        python "${SCRIPTDIR}"/e2e_config_edit.py  "${CONFIG_HOME}/instructlab/config.yaml" train.model_path "${MODEL_CACHE}/${HUGGINGFACE_DIR}/${GRANITE_7B_MODEL}/main"
        ...
        python "${SCRIPTDIR}"/e2e_config_edit.py  "${CONFIG_HOME}/instructlab/config.yaml" generate.teacher.model_path "${MODEL_CACHE}/${HUGGINGFACE_DIR}/${MISTRAL_GGUF_REPO}/main"
        ...
        python "${SCRIPTDIR}"/e2e_config_edit.py  "${CONFIG_HOME}/instructlab/config.yaml" train.phased_mt_bench_judge "${MODEL_CACHE}/${HUGGINGFACE_DIR}/${PROMETHEUS_8X7B_MODEL}/main"
        python "${SCRIPTDIR}"/e2e_config_edit.py  "${CONFIG_HOME}/instructlab/config.yaml" train.model_path "${MODEL_CACHE}/${HUGGINGFACE_DIR}/${GRANITE_7B_MODEL}/main"
        python "${SCRIPTDIR}"/e2e_config_edit.py  "${CONFIG_HOME}/instructlab/config.yaml" train.device cuda
