...
ilab init      # Initializes environment for labrador

ilab diff      # Diff taxonomy YAML files -- nothing modified

echo "^^^ 'ilab list' should have found no modified/new files"
...
ilab list      # List taxonomy YAML files
echo "^^^ Up there 'lab list' should have found 2 modified or new jokes/puns/ yaml files"

ilab generate  # Generates synthetic data to enhance your example data
...
# ilab download  # Download the model(s) to train
# ilab serve     # Start a local server
# ilab chat      # Run a chat using the modified model
# ilab test      # Perform rudimentary tests of the model
# ilab train     # Trains labrador model
