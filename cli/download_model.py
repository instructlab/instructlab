...
def download_model():
    ...
    click.echo("\nTemporarily, the model's files are hosted on GitHub, split in parts, and require to be downloaded manually and combined. To download the model, please follow the instructions below:")
    ...
    click.echo("\n2. Once the files are downloaded, you can use `cat` to combine them:")
