...
- `ilab data generate` now stores generated data from each run in individually dated directories. This will help users distinguish which run a specific generated dataset came from.
- `ilab data list` now supports dated per-run directories.
