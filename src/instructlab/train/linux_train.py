...
def linux_train(
    ...
    if device.type == "hpu":
        ...
        gta = GaudiTrainingArguments(**train_args, use_habana=True)
        gta.bf16 = True
        gta.use_lazy_mode = True
        # create checkpoint directories
        gta.save_on_each_node = True
        # gaudi_config_name=gaudi_config_name,
        if gta.per_device_train_batch_size == 1:
            gta.per_device_train_batch_size = 8
