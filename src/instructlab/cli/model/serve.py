...
from serve import serve_backend, signal_handler, warn_for_unsupported_backend_param
...
def serve(
    ...
    serve_backend(
        ctx, model_path, gpu_layers, num_threads, max_ctx_size, model_family, log_file, backend, chat_template, gpus
    )
