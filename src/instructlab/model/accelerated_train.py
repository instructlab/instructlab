...
def accelerated_train(
    ...
    phased_phase1_num_epochs: int,
    phased_phase1_samples_per_save: int,
    phased_phase1_effective_batch_size: int,
    phased_phase2_num_epochs: int,
    phased_phase2_samples_per_save: int,
    phased_phase2_effective_batch_size: int,
