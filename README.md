...
4. From your `venv` environment, verify `ilab` is installed correctly, by running the `ilab` command. For sample help text output from `ilab`, see the [CLI reference doc](docs/cli_reference.md).
